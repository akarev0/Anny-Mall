    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_cost', models.DecimalField(decimal_places=2, max_digits=9, verbose_name='Общая стоимость заказа')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='bboard.basket', verbose_name='Корзина')),
        ...
        migrations.AddField(
            model_name='basket',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bboard.customer', verbose_name='Владелец'),
        ),
        migrations.AddField(
            model_name='basket',
            name='products',
